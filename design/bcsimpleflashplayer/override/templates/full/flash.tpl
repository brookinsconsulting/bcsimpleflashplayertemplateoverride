...
{def $attribute=$node.data_map.file
     ...
     $videoPlayerSourceDirectory="/extension/bcsimpleflashplayertemplateoverride/design/bcsimpleflashplayer/flash/bcsimpleflashplayerexample/"
     ...
     $swfObjectDirectory=concat("/extension/bcsimpleflashplayertemplateoverride/design/bcsimpleflashplayer/javascript/","swfobject/")
}
